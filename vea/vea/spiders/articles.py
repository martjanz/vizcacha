...
class ArticlesSpider(scrapy.Spider):
    ...
    #
    # Request structure
    # curl 'https://www.veadigital.com.ar/Comprar/Menu.aspx?IdLocal=9119&IdTipoCompra=8&Fecha=20160118'
    #   method: POST
    ...
    def parse(self, response):
        ...
        yield scrapy.Request(
            url = "https://www.veadigital.com.ar/Login/Invitado.aspx",
            method = 'GET',
            headers = {
                'Referer': 'https://www.veadigital.com.ar/Comprar/Home.aspx',
                'Host': 'www.veadigital.com.ar'
            },
            cookies = {
    ...
    def getCategoryTree(self, response):
        ...
        yield scrapy.Request(
            url = ("https://www.veadigital.com.ar/Comprar/Menu.aspx"
                "?IdLocal=9119&IdTipoCompra=8"),
            method = 'GET',
            headers = {
                'Referer': 'https://www.veadigital.com.ar/Comprar/Home.aspx',
                'Host': 'www.veadigital.com.ar'
    ...
    def traverseCategories(self, categoryTree):
        ...
        for category in categoryTree:
            ...
            request = scrapy.Request(
                url = ("https://www.veadigital.com.ar/ajaxpro/"
                    "_MasterPages_Home"
                    ",VeaComprasWeb.ashx?method=MostrarGondola"),
                method = 'POST',
                headers = {
                    'Referer': 'https://www.veadigital.com.ar/Comprar/Home.aspx',
                    'Host': 'www.veadigital.com.ar',
    ...
    def followNextPage(self, idMenu, parents, nextPageNumber):
        ...
        request = scrapy.Request(
            url = ("https://www.veadigital.com.ar/ajaxpro/"
                "_MasterPages_Home"
                ",VeaComprasWeb.ashx?method=PecActualizar"),
            method = 'POST',
            headers = {
                'Referer': 'https://www.veadigital.com.ar/Comprar/Home.aspx',
                'Host': 'www.veadigital.com.ar',
